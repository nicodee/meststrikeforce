...
href="incubator@meltwater.org" lang="en">Forward</a></div>
</td>
</tr>
</tbody>
</table>
...
style="color: rgb(102, 102, 102);">This email is to confirm that you've been added to our contact database. Our incubator entrepreneurs will reach out directly when they need your valuable skills! 
</span><br style="color: rgb(102, 102, 102);">
<br style="color: rgb(102, 102, 102);">
<span style="color: rgb(102, 102, 102);">
Messages from our entrepreneurs will come with the subject line prefix [MSF], so look out for emails with that prefix.</span><br
...
<div class="article-content" align="left">
Now that you've been added to our contact database, our entrepreneurs will occasionally reach out when they need help.
<br>
<br>
If you have any questions, please get in touch at
<a href="mailto:incubator@meltwater.org"><span style="font-size:15px;font-family:Arial;color:#1155cc;background-color:transparent;font-weight:normal;font-style:normal;font-variant:normal;text-decoration:underline;vertical-align:baseline;">incubator@meltwater.org</span></a>. Once again, welcome!
<br>
<br>
Best regards,<br>
The MEST Team
	...
	<table border="0" cellpadding="0" cellspacing="0">
		<tbody>
			<tr>
				...
				<td valign="middle">
					<div class="header-content">
						<a href="incubator@meltwater.org" lang="en">
							Forward
						</a>
					</div>
				</td>
	...
	<tbody>
		<tr>
			<td class="w580" width="580">
				<div class="article-content" align="left">
					<span style="color: rgb(102, 102, 102);">
						Hi *|firstname|* - Thank you for joining the MEST Strike Force! 
					</span>
					<br	style="color: rgb(102, 102, 102);">
					<br	style="color: rgb(102, 102, 102);">
					<span style="color: rgb(102, 102, 102);">
						We'll review your information shortly and follow-up as soon as we have an opportunity to engage you with one or more of our incubator companies here at MEST. We're very excited to have you on board, and thank you in advance for the help and special skills that you will bring to our entrepreneurs. 
					</span>
					<br	style="color: rgb(102, 102, 102);">
					<br	style="color: rgb(102, 102, 102);">
					<span style="color: rgb(102, 102, 102);">
						If you have any questions, please contact <a href="mailto:incubator@meltwater.org">incubator@meltwater.org</a>
					</span>
				</div>
			</td>
		</tr>
...
<!-- 					<span style="color: rgb(102, 102, 102);">
					...
					<span style="color: rgb(102, 102, 102);">
						A new MEST Strike Force member is waiting to be confirmed!
					</span>
					...
					<span style="color: rgb(102, 102, 102);">
						To confirm this MSF, member, kindly log into *|confirmation_url|*
					</span>
					<br	style="color: rgb(102, 102, 102);">
					<br	style="color: rgb(102, 102, 102);">
...
signup_template_entrepreneur = """<html>
<head>
<title>MEST Strike Force</title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<meta name="viewport"
		...
		<tr>
			<td class="w580" width="580">
				<div class="article-content" align="left">
					...
					<br	style="color: rgb(102, 102, 102);">
					<span style="color: rgb(102, 102, 102);">
						We'll review your information shortly and follow-up very soon.
					</span>
					<br	style="color: rgb(102, 102, 102);">
					<span style="color: rgb(102, 102, 102);">
						If you have any questions, please contact <a href="mailto:incubator@meltwater.org">incubator@meltwater.org</a>
